...
import com.example.shoppingmall02.config.jwt.JwtSecurityConfig;
import com.example.shoppingmall02.config.oauth.OAuth2FailHandler;
import com.example.shoppingmall02.config.oauth.OAuth2SuccessHandler;
import com.example.shoppingmall02.config.oauth.PrincipalOAuth2UserService;
import com.example.shoppingmall02.exception.jwt.JwtAccessDeniedHandler;
import com.example.shoppingmall02.exception.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        ...
        encode.put(idForEncode, new BCryptPasswordEncoder());
        return new DelegatingPasswordEncoder(idForEncode, encode);
    }
